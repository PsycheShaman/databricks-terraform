...
zoopla_publishing_service.zip:
	cd zoopla_publishing_service && zip -r ../zoopla_publishing_service.zip lambda_function.py

raw_listings_s3_event_lambda.zip:
	cd raw_listings_s3_event_lambda && zip -r ../raw_listings_s3_event_lambda.zip lambda_function.py
